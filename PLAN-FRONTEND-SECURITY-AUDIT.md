...
|---|-------|-------|----------|----------|
| 1 | Client-side secrets | PASS | **PASS — agree** | Bundle carries Firebase config + Sentry DSN only. Both are public by design. Gemini key absent (rotated 2026-08-24, see memory `gemini-leak-correction`). |
