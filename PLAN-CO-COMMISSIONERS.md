...
## 7. Implementation tickets — §6 signed 2026-08-15; SHIPPED AND LIVE 2026-08-16

> **Status 2026-08-16: ✅ SHIPPED END TO END.** #446 + #447 merged; functions,
> rules, `firestore.indexes` and Coolify all deployed by Kevin in D2 order;
> browser smoke passed (owner toggle → badge; co-commissioner sees the
> Commissioner tab and the Hub card, and no Cancel/billing). **Every ticket
> T1–T7 is live and nothing from this plan is owed on any deploy queue.**
> Recorded here 2026-08-28 — this line is the salvaged half of PR #448, which
> was closed because its other two edits were superseded.
>
