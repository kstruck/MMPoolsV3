...
> **Status 2026-08-16: ✅ SHIPPED END TO END.** #446 + #447 merged; functions, rules, indexes and Coolify deployed by Kevin; browser smoke passed (toggle/badge, co-commissioner sees Commissioner tab + Hub card, no Cancel/billing). Every ticket T1–T7 is live.
>
