...
**26 mutations applied across the two files, all 26 killed** — including
...
to `Math.max`, putting the raw kickoff back in place of the enforced lock, and
removing the weekly-lock type gate.
