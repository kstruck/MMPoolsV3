...
// 12 as of PLAN-AUDIT-AUTH-HARDENING Phase B (poolPrivateAccess.rules.test.mjs).
// It had drifted to one BELOW the file count before that — the empty-pass guard
