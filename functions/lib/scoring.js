...
exports.calculateTiebreakerDiff = calculateTiebreakerDiff;
// ----------------------------------------------------------------------------
// Constants
// ----------------------------------------------------------------------------
...
// Scoring Logic
// ----------------------------------------------------------------------------
function calculateScore(entry, tournament, settings) {
    let totalScore = 0;
    let maxPossible = 0;
    let correctPicks = 0;
    ...
    for (const slot of allSlots) {
        ...
        if (!pickedTeamId)
            continue; // No pick for this slot (shouldn't happen if full)
        ...
        if (roundIndex < 0 || roundIndex >= 6)
            continue; // Skip First Four or invalid rounds
 ...
 */
function isTeamAlive(teamId, tournament, targetRound) {
...
// Tiebreaker Logic
// ----------------------------------------------------------------------------
function calculateTiebreakerDiff(entry, tournament) {
