...
exports.syncGameStatus = (0, scheduler_1.onSchedule)({
    ...
    for (const doc of poolsSnap.docs) {
        ...
        const newScores = Object.assign(Object.assign({}, pool.scores), { current: { home: homeScore, away: awayScore }, gameStatus: state, period: period, clock: displayClock, startTime: gameDate });
        // Deep check to strictly avoid unnecessary writes (infinite loops)
        const isChanged = JSON.stringify(newScores.current) !== JSON.stringify(pool.scores.current) ||
