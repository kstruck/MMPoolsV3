...
export const autoClosePools = functions.scheduler.onSchedule(
  // 04:00 ET. Was "every day 08:00" with no timeZone == 08:00 UTC == 04:00 ET
  // during EDT; now fixed at 04:00 ET year-round. See
  // __tests__/scheduleTimezones.test.ts for the DST tradeoff.
