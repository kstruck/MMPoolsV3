...
python skills/skill-senior-frontend/scripts/component_generator.py [options]

# Script 2: Bundle Analyzer
python skills/skill-senior-frontend/scripts/bundle_analyzer.py [options]

# Script 3: Frontend Scaffolder
python skills/skill-senior-frontend/scripts/frontend_scaffolder.py [options]
```
...
**Usage:**
```bash
python skills/skill-senior-frontend/scripts/component_generator.py <project-path> [options]
```
...
**Usage:**
```bash
python skills/skill-senior-frontend/scripts/bundle_analyzer.py <target-path> [--verbose]
```
...
**Usage:**
```bash
python skills/skill-senior-frontend/scripts/frontend_scaffolder.py [arguments] [options]
```
...
python skills/skill-senior-frontend/scripts/bundle_analyzer.py .
...
# Analysis
python skills/skill-senior-frontend/scripts/bundle_analyzer.py .
python skills/skill-senior-frontend/scripts/frontend_scaffolder.py --analyze
