...
python skills/skill-senior-backend/scripts/api_scaffolder.py [options]

# Script 2: Database Migration Tool
python skills/skill-senior-backend/scripts/database_migration_tool.py [options]

# Script 3: Api Load Tester
python skills/skill-senior-backend/scripts/api_load_tester.py [options]
```
...
**Usage:**
```bash
python skills/skill-senior-backend/scripts/api_scaffolder.py <project-path> [options]
```
...
**Usage:**
```bash
python skills/skill-senior-backend/scripts/database_migration_tool.py <target-path> [--verbose]
```
...
**Usage:**
```bash
python skills/skill-senior-backend/scripts/api_load_tester.py [arguments] [options]
```
...
python skills/skill-senior-backend/scripts/database_migration_tool.py .
...
# Analysis
python skills/skill-senior-backend/scripts/database_migration_tool.py .
python skills/skill-senior-backend/scripts/api_load_tester.py --analyze
