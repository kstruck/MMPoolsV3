...
python skills/skill-senior-fullstack/scripts/fullstack_scaffolder.py [options]

# Script 2: Project Scaffolder
python skills/skill-senior-fullstack/scripts/project_scaffolder.py [options]

# Script 3: Code Quality Analyzer
python skills/skill-senior-fullstack/scripts/code_quality_analyzer.py [options]
```
...
**Usage:**
```bash
python skills/skill-senior-fullstack/scripts/fullstack_scaffolder.py <project-path> [options]
```
...
**Usage:**
```bash
python skills/skill-senior-fullstack/scripts/project_scaffolder.py <target-path> [--verbose]
```
...
**Usage:**
```bash
python skills/skill-senior-fullstack/scripts/code_quality_analyzer.py [arguments] [options]
```
...
python skills/skill-senior-fullstack/scripts/project_scaffolder.py .
...
# Analysis
python skills/skill-senior-fullstack/scripts/project_scaffolder.py .
python skills/skill-senior-fullstack/scripts/code_quality_analyzer.py --analyze
