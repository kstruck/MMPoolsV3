...
export const TermsPage: React.FC<Props> = (props) => {
    return (
        <div className="min-h-screen bg-page text-[color:var(--text)] font-body">
            ...
            {/* Content — content body (flips) */}
            <div className="max-w-4xl mx-auto px-6 py-16">
                <h1 className="text-4xl font-display font-extrabold uppercase leading-none text-[color:var(--text)] mb-4">Terms of Service</h1>
                <p className="text-muted mb-12 num">Last Updated: March 10, 2026</p>

                <div className="prose max-w-none space-y-8">
                    <section>
                        <h2 className="text-2xl font-display font-bold uppercase text-[color:var(--text)] mb-4">1. Acceptance of Terms</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-display font-bold uppercase text-[color:var(--text)] mb-4">2. Use License</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-display font-bold uppercase text-[color:var(--text)] mb-4">3. User Responsibilities</h2>
                        <h3 className="text-xl font-display font-bold uppercase text-[color:var(--text)] mb-2 mt-6">3.1 Account Security</h3>
                        <p className="text-muted leading-relaxed">
                            You are responsible for maintaining the confidentiality of your account credentials and for all activities that occur under your account.
                        </p>

                        <h3 className="text-xl font-display font-bold uppercase text-[color:var(--text)] mb-2 mt-6">3.2 Accurate Information</h3>
                        <p className="text-muted leading-relaxed">
                            You agree to provide accurate, current, and complete information when creating pools or participating in the Service.
                        </p>

                        <h3 className="text-xl font-display font-bold uppercase text-[color:var(--text)] mb-2 mt-6">3.3 Prohibited Conduct</h3>
                        <ul className="list-disc pl-6 space-y-2 text-muted">
                    ...
                    <section className="bg-card border border-line rounded-xl p-6">
                        <h2 className="text-2xl font-display font-bold uppercase text-[color:var(--text)] mb-4">4. Gambling Disclaimer</h2>
                        <p className="text-muted leading-relaxed mb-4">
                    ...
                    <section className="bg-card border border-line rounded-xl p-6">
                        <h2 className="text-2xl font-display font-bold uppercase text-[color:var(--text)] mb-4">5. SMS/Text Messaging Terms</h2>
                        <p className="text-muted leading-relaxed mb-4">
                        ...
                        <h3 className="text-xl font-display font-bold uppercase text-[color:var(--text)] mb-2 mt-6">5.1 Consent</h3>
                        <p className="text-muted leading-relaxed">
                        ...
                        <h3 className="text-xl font-display font-bold uppercase text-[color:var(--text)] mb-2 mt-6">5.2 Types of Messages</h3>
                        <p className="text-muted leading-relaxed mb-2">You may receive the following types of text messages:</p>
                        <ul className="list-disc pl-6 space-y-2 text-muted">
                        ...
                        <h3 className="text-xl font-display font-bold uppercase text-[color:var(--text)] mb-2 mt-6">5.3 Message Frequency</h3>
                        <p className="text-muted leading-relaxed">
                        ...
                        <h3 className="text-xl font-display font-bold uppercase text-[color:var(--text)] mb-2 mt-6">5.4 Opt-Out</h3>
                        <p className="text-muted leading-relaxed">
                        ...
                        <h3 className="text-xl font-display font-bold uppercase text-[color:var(--text)] mb-2 mt-6">5.5 Costs</h3>
                        <p className="text-muted leading-relaxed">
                        ...
                        <h3 className="text-xl font-display font-bold uppercase text-[color:var(--text)] mb-2 mt-6">5.6 Help</h3>
                        <p className="text-muted leading-relaxed">
                            For help or questions about SMS notifications, reply <strong>HELP</strong> to any message or contact us at <a href="mailto:support@marchmeleepools.com" className="text-gold-600 dark:text-gold-400 hover:underline">support@marchmeleepools.com</a>.
                        </p>

                        <h3 className="text-xl font-display font-bold uppercase text-[color:var(--text)] mb-2 mt-6">5.7 Carrier Disclaimer</h3>
                        <p className="text-muted leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-2xl font-display font-bold uppercase text-[color:var(--text)] mb-4">6. Pool Management</h2>
                        <p className="text-muted leading-relaxed mb-4">
                    ...
                    <section>
                        <h2 className="text-2xl font-display font-bold uppercase text-[color:var(--text)] mb-4">7. Intellectual Property</h2>
                        <p className="text-muted leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-2xl font-display font-bold uppercase text-[color:var(--text)] mb-4">8. Limitation of Liability</h2>
                        <p className="text-muted leading-relaxed mb-4">
                    ...
                    <section>
                        <h2 className="text-2xl font-display font-bold uppercase text-[color:var(--text)] mb-4">9. Disclaimer of Warranties</h2>
                        <p className="text-muted leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-2xl font-display font-bold uppercase text-[color:var(--text)] mb-4">10. Dispute Resolution</h2>
                        <p className="text-muted leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-2xl font-display font-bold uppercase text-[color:var(--text)] mb-4">11. Termination</h2>
                        <p className="text-muted leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-2xl font-display font-bold uppercase text-[color:var(--text)] mb-4">12. Changes to Terms</h2>
                        <p className="text-muted leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-2xl font-display font-bold uppercase text-[color:var(--text)] mb-4">13. Contact Information</h2>
                        <p className="text-muted leading-relaxed">
                            For questions about these Terms, please contact:
                        </p>
                        <p className="text-muted leading-relaxed mt-4">
                            <strong>Email:</strong> <a href="mailto:support@marchmeleepools.com" className="text-gold-600 dark:text-gold-400 hover:underline">support@marchmeleepools.com</a>
                        </p>
                    </section>
                </div>
            </div>
