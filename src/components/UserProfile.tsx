                ...
                {user.role === 'SUPER_ADMIN' && (
                    <div className="bg-gold-500/10 border border-gold-500/30 rounded-xl p-6 relative overflow-hidden">
                        ...
                        <button
                            ...
                            className="bg-gold-foil hover:brightness-105 text-navy-900 font-display font-bold uppercase tracking-[0.05em] px-5 py-2.5 rounded-lg text-sm transition-ui duration-150 shadow-[0_6px_16px_rgba(140,109,51,0.28)]"
                        >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="pt-4 flex justify-end gap-3">
                            ...
                            <button
                                type="submit"
                                disabled={isSaving}
                                className="bg-brandred-600 hover:bg-brandred-500 disabled:opacity-50 disabled:cursor-not-allowed text-white px-8 py-2.5 rounded-md font-display font-bold uppercase tracking-[0.05em] shadow-[0_6px_16px_rgba(196,52,46,0.28)] transition-ui duration-150 fine:hover:-translate-y-px flex items-center gap-2"
                            >
                        ...
                        <form onSubmit={handleEmailUpdate} className="space-y-4">
                            ...
                            <div className="pt-4 flex justify-end gap-3 border-t border-line mt-6 md:mt-8">
                                ...
                                <button
                                    ...
                                    className="bg-brandred-600 hover:bg-brandred-500 disabled:opacity-50 text-white px-6 py-2 rounded-md font-display font-bold uppercase tracking-[0.05em] shadow-[0_6px_16px_rgba(196,52,46,0.28)] flex items-center gap-2 transition-ui duration-150"
                                >
