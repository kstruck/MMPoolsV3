        ...
        <div className="max-w-[1400px] mx-auto px-4 mb-10 w-full">
            <div className="flex flex-wrap justify-center gap-6">
                {quarterlyPayouts
                    ...
                    .map((card, idx) => {
                        return (
                            <div key={idx} className="bg-card border border-line rounded-xl p-6 text-center shadow-card transition duration-150 hover:-translate-y-1 hover:shadow-card-hover relative overflow-hidden group w-full md:w-[320px]">
