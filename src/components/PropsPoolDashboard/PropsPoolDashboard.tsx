                    ...
                    <div className="max-w-4xl mx-auto space-y-6">
                        ...
                        <div className="bg-card border border-line rounded-xl shadow-card p-6 flex flex-col md:flex-row justify-between items-center gap-4">
                            ...
                            <button
                                ...
                                id="btn-fix-sync"
                                className="bg-gold-foil text-navy-900 hover:brightness-105 px-4 py-2 rounded-lg font-display font-bold uppercase tracking-[0.05em] flex items-center gap-2 transition duration-150 hover:-translate-y-px"
                            >
