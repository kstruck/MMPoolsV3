...
/* Hero stays navy chrome (always dark); content sections below flip light/dark. */
    ...
    return (
        <div className="min-h-screen bg-page text-[color:var(--text)] font-body">
            ...
            <main>
                ...
                {/* Audit & Integrity — flips */}
                <section className="py-20 px-4 bg-surface border-y border-line">
                    <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div className="space-y-8">
                            <div className="inline-flex items-center gap-2 text-gold-600 dark:text-gold-400 font-display font-bold uppercase tracking-[0.16em] text-sm">
                                <Shield size={20} /> Integrity First
                            </div>
                            <h2 className="font-display font-extrabold uppercase text-4xl leading-[0.95] text-[color:var(--text)]">Fully Auditable & <br />Tamper-Proof.</h2>
                            ...
                            <ul className="space-y-4">
                                {[
                                    { title: 'Secure Number Generation', desc: 'Axis numbers are generated server-side using cryptographic RNG.', icon: <Lock className="text-gold-600 dark:text-gold-400" size={20} /> },
                                    { title: 'Public Audit Trail', desc: 'Any user can inspect the full timeline of events, ensuring 100% transparency.', icon: <Users className="text-navy-700 dark:text-[#9FB0CC]" size={20} /> },
                                    { title: 'Strict Permissions', desc: 'Even pool managers cannot alter numbers or locked grids once set.', icon: <Shield className="text-gold-600 dark:text-gold-400" size={20} /> }
                                ].map((item, i) => (
                                    <li key={i} className="flex gap-4">
                                        <div className="mt-1 bg-surface p-2 rounded-lg border border-line">{item.icon}</div>
                                        <div>
                                            <h3 className="font-display font-bold uppercase text-[color:var(--text)]">{item.title}</h3>
                        ...
                        <div className="relative">
                            ...
                            <div className="bg-card border border-line rounded-2xl p-6 shadow-panel rotate-3 hover:rotate-0 transition-transform duration-500">
                                <div className="flex items-center justify-between mb-6 border-b border-line pb-4">
                                    <h3 className="font-mono text-sm text-faint">AUDIT_LOG_VIEWER_V1.0</h3>
                                    <span className="font-display font-bold uppercase text-xs tracking-[0.08em] bg-gold-500/15 text-gold-600 dark:text-gold-400 border border-gold-500/25 px-2 py-0.5 rounded">VIFIED_SECURE</span>
                                </div>
                                <div className="space-y-3 font-mono text-xs num">
                                    <div className="flex gap-3 text-muted"><span className="text-faint">14:02:01</span> <span>POOL_CREATED: ID_99281</span></div>
                                    <div className="flex gap-3 text-gold-600 dark:text-gold-400"><span className="text-faint">15:30:10</span> <span>NUMBERS_GENERATED: [0,4,2,1...]</span></div>
                                    <div className="flex gap-3 text-muted"><span className="text-faint">15:30:11</span> <span>POOL_LOCKED_BY_SYSTEM</span></div>
                                    <div className="flex gap-3 text-brandred-500"><span className="text-faint">18:45:22</span> <span>GAME_SCORE_UPDATE: (7-0)</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                {/* AI Commissioner — flips */}
                <section className="py-20 px-4 bg-page">
                    <div className="max-w-5xl mx-auto text-center mb-16">
                        <div className="inline-flex items-center gap-2 text-gold-600 dark:text-gold-400 font-display font-bold uppercase tracking-[0.16em] text-sm mb-4">
                            <Brain size={20} /> Powered by Gemini AI
                        </div>
                        <h2 className="font-display font-extrabold uppercase text-4xl md:text-5xl leading-[0.95] text-[color:var(--text)] mb-6">Meet Your New <br />AI Commissioner.</h2>
                        <p className="text-xl font-body text-muted max-w-2xl mx-auto">
                            A neutral, unbiased AI that settles disputes, explains winning squares, and answers player questions instantly.
                        </p>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                        <div className="bg-card border border-line p-8 rounded-2xl hover:border-gold-500/40 transition-colors">
                            <MessageCircle className="text-gold-600 dark:text-gold-400 mb-6" size={40} />
                            <h3 className="font-display font-bold uppercase text-xl text-[color:var(--text)] mb-3">Dispute Resolution</h3>
                            <p className="font-body text-muted">Players can ask "Did the numbers change?" or "Who won Q1?". The AI analyzes the audit log and provides fact-based answers.</p>
                        </div>
                        <div className="bg-card border border-line p-8 rounded-2xl hover:border-gold-500/40 transition-colors">
                            <Trophy className="text-gold-600 dark:text-gold-400 mb-6" size={40} />
                            <h3 className="font-display font-bold uppercase text-xl text-[color:var(--text)] mb-3">Winner Explanations</h3>
                            <p className="font-body text-muted">Confused by the grid? The AI generates plain-english breakdowns of exactly why a square won (e.g., "Score 7-3 -&gt; Digits 7 & 3").</p>
                        </div>
                        <div className="bg-card border border-line p-8 rounded-2xl hover:border-gold-500/40 transition-colors">
                            <Zap className="text-navy-700 dark:text-[#9FB0CC] mb-6" size={40} />
                            <h3 className="font-display font-bold uppercase text-xl text-[color:var(--text)] mb-3">Zero Hallucinations</h3>
                            <p className="font-body text-muted">Built with strict "Facts Only" protocols. If the data isn't in the Audit Log, the AI won't make it up.</p>
                        </div>
                    </div>
                </section>

                {/* Feature Deep Dive: Live Grid — flips */}
                <section className="py-20 px-4 bg-surface border-b border-line">
                    <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
                        <div className="md:w-1/2 space-y-6">
                            ...
                            <h2 className="font-display font-extrabold uppercase text-4xl leading-[0.95] text-[color:var(--text)]">Live 10x10 Grid. <br />No Refreshing Needed.</h2>
                            <p className="font-body text-muted text-lg leading-relaxed">
                            ...
                            <ul className="space-y-3">
                                {[
                                    ...
                                    <li key={i} className="flex items-center gap-3 font-body text-[color:var(--text)]">
                ...
                {/* Feature Deep Dive: Scoreboard — flips */}
                <section className="py-20 px-4 bg-page border-b border-line">
                    <div className="max-w-6xl mx-auto flex flex-col md:flex-row-reverse items-center gap-12">
                        <div className="md:w-1/2 space-y-6">
                            <div className="inline-flex items-center gap-2 text-gold-600 dark:text-gold-400 font-display font-bold uppercase tracking-[0.16em] text-sm">
                                <Zap size={20} /> Mission Control
                            </div>
                            <h2 className="font-display font-extrabold uppercase text-4xl leading-[0.95] text-[color:var(--text)]">Live Scoreboard & <br />Pool Stats.</h2>
                            <p className="font-body text-muted text-lg leading-relaxed">
                ...
                {/* Feature Deep Dive: Scenarios — flips */}
                <section className="py-20 px-4 bg-surface border-b border-line">
                    <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
                        <div className="md:w-1/2 space-y-6">
                            <div className="inline-flex items-center gap-2 text-gold-600 dark:text-gold-400 font-display font-bold uppercase tracking-[0.16em] text-sm">
                            ...
                            <h2 className="font-display font-extrabold uppercase text-4xl leading-[0.95] text-[color:var(--text)]">Winning Scenarios <br />Calculator.</h2>
                            <p className="font-body text-muted text-lg leading-relaxed">
                ...
                {/* Feature Deep Dive: Setup Wizard — flips */}
                <section className="py-20 px-4 bg-page border-b border-line">
                    <div className="max-w-6xl mx-auto flex flex-col md:flex-row-reverse items-center gap-12">
                        <div className="md:w-1/2 space-y-6">
                            <div className="inline-flex items-center gap-2 text-gold-600 dark:text-gold-400 font-display font-bold uppercase tracking-[0.16em] text-sm">
                            ...
                            <h2 className="font-display font-extrabold uppercase text-4xl leading-[0.95] text-[color:var(--text)]">Setup in Seconds. <br />Manage with Ease.</h2>
                            <p className="font-body text-muted text-lg leading-relaxed">
                ...
                {/* More Features Grid — flips */}
                <section className="py-20 px-4 bg-surface">
                    <div className="max-w-6xl mx-auto">
                        <div className="text-center mb-12">
                            <h2 className="font-display font-extrabold uppercase text-3xl leading-[0.95] text-[color:var(--text)] mb-4">And Much More...</h2>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="bg-card p-6 rounded-xl border border-line flex flex-col items-center text-center">
                                <div className="w-12 h-12 rounded-full bg-gold-500/15 flex items-center justify-center text-gold-600 dark:text-gold-400 mb-4">
                                    <Smartphone size={24} />
                                </div>
                                <h3 className="font-display font-bold uppercase text-lg text-[color:var(--text)] mb-2">Mobile Optimized</h3>
                                <p className="font-body text-muted text-sm">Built for phones first. Checking your squares is as easy as checking your text messages.</p>
                            </div>
                            <div className="bg-card p-6 rounded-xl border border-line flex flex-col items-center text-center">
                                <div className="w-12 h-12 rounded-full bg-navy-600/15 flex items-center justify-center text-navy-700 dark:text-[#9FB0CC] mb-4">
                                    <Mail size={24} />
                                </div>
                                <h3 className="font-display font-bold uppercase text-lg text-[color:var(--text)] mb-2">Smart Notifications</h3>
                                <p className="font-body text-muted text-sm">Automated email alerts for pool invites, pick confirmations, and winner announcements.</p>
                            </div>
                            <div className="bg-card p-6 rounded-xl border border-line flex flex-col items-center text-center">
                                <div className="w-12 h-12 rounded-full bg-gold-500/15 flex items-center justify-center text-gold-600 dark:text-gold-400 mb-4">
                                    <Lock size={24} />
                                </div>
                                <h3 className="font-display font-bold uppercase text-lg text-[color:var(--text)] mb-2">Private & Secure</h3>
                                <p className="font-body text-muted text-sm">Password protect your pool and rely on enterprise-grade security for your data.</p>
                            </div>
                        </div>
                    </div>
                </section>
                <section className="py-20 text-center px-4 bg-page">
                    <div className="max-w-3xl mx-auto bg-card border border-gold-500/35 rounded-3xl p-12 relative overflow-hidden">
                        <div className="absolute top-0 right-0 w-64 h-64 bg-gold-500/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2"></div>

                        <h2 className="font-display font-extrabold uppercase text-3xl md:text-5xl leading-[0.95] text-[color:var(--text)] mb-6 relative z-10">Ready to Start?</h2>
