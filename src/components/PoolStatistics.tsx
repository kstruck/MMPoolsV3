        ...
        <div className="space-y-6">
            ...
            <div className="bg-card border border-line rounded-xl p-6 shadow-card">
                ...
                <div className="mb-4">
                    ...
                    <div className="h-3 bg-line rounded-full overflow-hidden">
                        <div
                            ...
                            style={{ transform: `scaleX(${Number(percentSold) / 100})` }}
                        />
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="h-3 bg-line rounded-full overflow-hidden">
                        <div
                            className="h-full w-full origin-left bg-[#0F7B4A] transition-transform duration-300"
                            style={{ transform: `scaleX(${Number(percentPaid) / 100})` }}
                        />
                    </div>
                </div>
            </div>
