      ...
      <div className="bg-card border border-line rounded-2xl shadow-panel overflow-hidden">
        ...
        <div className="p-8 space-y-6">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full bg-white text-navy-900 font-display font-bold uppercase tracking-[0.05em] py-3 px-4 rounded-md border border-line flex items-center justify-center gap-3 hover:bg-cream transition duration-150 hover:-translate-y-px disabled:opacity-50 disabled:cursor-not-allowed disabled:translate-y-0"
          >
