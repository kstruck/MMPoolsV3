            ...
            <div className="max-w-4xl mx-auto px-6 py-16">
                ...
                <div className="prose prose-invert max-w-none space-y-8">
                    ...
                    <section>
                        ...
                        <h3 className="text-xl font-bold text-white mb-2 mt-6">2.2 Automatically Collected Information</h3>
                        <ul className="list-disc pl-6 space-y-2 text-slate-300">
                    ...
                    <section className="bg-indigo-900/20 border border-indigo-500/30 rounded-xl p-6">
                        <h2 className="text-2xl font-bold text-white mb-4">4. We Never Sell Your Data</h2>
                    ...
                    <section>
                        ...
                        <p className="text-slate-300 leading-relaxed mb-4">We may share your information only in the following circumstances:</p>
                        <ul className="list-disc pl-6 space-y-2 text-slate-300">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-white mb-4">11. Google User Data & Limited Use</h2>
                        <p className="text-slate-300 leading-relaxed mb-4">
                            March Melee Pools' use and transfer to any other app of information received from Google APIs will adhere to the <a href="https://developers.google.com/terms/api-services-user-data-policy" className="text-indigo-400 hover:underline" target="_blank" rel="noopener noreferrer">Google API Services User Data Policy</a>, including the Limited Use requirements.
                        </p>
                        <p className="text-slate-300 leading-relaxed">
                            Specifically:
                        </p>
