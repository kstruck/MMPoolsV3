    ...
    return (
        <div className="min-h-screen bg-page text-[color:var(--text)] font-body">
            ...
            <div className="max-w-4xl mx-auto px-6 py-16">
                <h1 className="font-display font-extrabold uppercase text-4xl leading-[0.95] text-[color:var(--text)] mb-4">Privacy Policy</h1>
                <p className="text-muted mb-12 num">Last Updated: March 10, 2026</p>

                <div className="prose max-w-none space-y-8">
                    <section>
                        <h2 className="font-display font-bold uppercase text-2xl text-[color:var(--text)] mb-4">1. Introduction</h2>
                    ...
                    <section>
                        <h2 className="font-display font-bold uppercase text-2xl text-[color:var(--text)] mb-4">2. Information We Collect</h2>
                        <h3 className="font-display font-bold uppercase text-xl text-[color:var(--text)] mb-2 mt-6">2.1 Information You Provide</h3>
                        ...
                        <h3 className="font-display font-bold uppercase text-xl text-[color:var(--text)] mb-2 mt-6">2.2 Automatically Collected Information</h3>
                        <ul className="list-disc pl-6 space-y-2 text-muted">
                    ...
                    <section>
                        <h2 className="font-display font-bold uppercase text-2xl text-[color:var(--text)] mb-4">3. How We Use Your Information</h2>
                    ...
                    <section className="bg-card border border-line rounded-xl p-6">
                        <h2 className="font-display font-bold uppercase text-2xl text-[color:var(--text)] mb-4">4. We Never Sell Your Data</h2>
                    ...
                    <section>
                        <h2 className="font-display font-bold uppercase text-2xl text-[color:var(--text)] mb-4">5. Data Sharing and Disclosure</h2>
                        <p className="text-muted leading-relaxed mb-4">We may share your information only in the following circumstances:</p>
                        <ul className="list-disc pl-6 space-y-2 text-muted">
                    ...
                    <section>
                        <h2 className="font-display font-bold uppercase text-2xl text-[color:var(--text)] mb-4">6. Data Security</h2>
                        <p className="text-muted leading-relaxed">
                    ...
                    <section>
                        <h2 className="font-display font-bold uppercase text-2xl text-[color:var(--text)] mb-4">7. Your Rights</h2>
                        <p className="text-muted leading-relaxed mb-4">Depending on your location, you may have the following rights:</p>
                        <ul className="list-disc pl-6 space-y-2 text-muted">
                        ...
                        <p className="text-muted leading-relaxed mt-4">
                            To exercise these rights, contact us at <a href="mailto:support@marchmeleepools.com" className="text-gold-600 dark:text-gold-400 hover:underline">support@marchmeleepools.com</a>.
                        </p>
                    </section>

                    <section>
                        <h2 className="font-display font-bold uppercase text-2xl text-[color:var(--text)] mb-4">8. Cookies and Tracking</h2>
                        <p className="text-muted leading-relaxed">
                    ...
                    <section>
                        <h2 className="font-display font-bold uppercase text-2xl text-[color:var(--text)] mb-4">9. Children's Privacy</h2>
                        <p className="text-muted leading-relaxed">
                    ...
                    <section>
                        <h2 className="font-display font-bold uppercase text-2xl text-[color:var(--text)] mb-4">10. Changes to This Policy</h2>
                        <p className="text-muted leading-relaxed">
                    ...
                    <section>
                        <h2 className="font-display font-bold uppercase text-2xl text-[color:var(--text)] mb-4">11. Google User Data & Limited Use</h2>
                        <p className="text-muted leading-relaxed mb-4">
                            March Melee Pools' use and transfer to any other app of information received from Google APIs will adhere to the <a href="https://developers.google.com/terms/api-services-user-data-policy" className="text-gold-600 dark:text-gold-400 hover:underline" target="_blank" rel="noopener noreferrer">Google API Services User Data Policy</a>, including the Limited Use requirements.
                        </p>
                        <p className="text-muted leading-relaxed">
                            Specifically:
                        </p>
                    ...
                    <section>
                        <h2 className="font-display font-bold uppercase text-2xl text-[color:var(--text)] mb-4">12. Contact Us</h2>
                        <p className="text-muted leading-relaxed">
