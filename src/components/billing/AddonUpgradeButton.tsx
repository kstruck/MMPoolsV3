...
export const AddonUpgradeButton: React.FC<{
  ...
  return (
    <button
      ...
      onClick={buy}
      disabled={busy}
      className={className ?? 'mt-2 inline-flex items-center gap-1.5 border border-gold-500/60 text-gold-700 dark:text-gold-300 px-4 py-2 rounded-md font-display font-bold uppercase text-[10px] tracking-[0.08em] transition duration-150 hover:bg-gold-500/10 disabled:opacity-50 disabled:cursor-not-allowed'}
    >
