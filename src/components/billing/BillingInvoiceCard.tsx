        ...
        <div className="bg-slate-900/60 backdrop-blur-md border border-slate-800 rounded-2xl p-6 md:p-8 space-y-6 shadow-2xl relative overflow-hidden">
            ...
            {isWizard && (
                <div className="bg-slate-950/40 border border-slate-800 rounded-xl p-4 space-y-3">
                    <h4 className="text-xs font-bold text-white uppercase tracking-wider flex items-center gap-1.5 text-indigo-400">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-1">
                        {[
                            ...
                            return (
                                <label key={key} className="flex items-start gap-2.5 p-2.5 rounded-lg bg-slate-900 border border-slate-850 hover:border-slate-750 cursor-pointer transition-all hover:bg-slate-900/80 group">
                                    <input 
                                        type="checkbox" 
                                        checked={!!value}
