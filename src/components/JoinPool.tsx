                  ...
                  <span className="flex items-center gap-1.5 ml-1 inline-flex">
                    {(castPool.contactMethod === 'email' || castPool.contactMethod === 'both' || !castPool.contactMethod) && pool.contactEmail && (
                      <a
                        ...
                        className="p-1 bg-navy-600/10 hover:bg-navy-600/20 text-navy-700 dark:text-[#9FB0CC] border border-navy-600/20 rounded-md transition hover:scale-105 flex items-center justify-center cursor-pointer"
                    ...
                    {(castPool.contactMethod === 'phone' || castPool.contactMethod === 'both') && castPool.contactPhone && (
                      <a
                        ...
                        className="p-1 bg-gold-500/10 hover:bg-gold-500/20 text-gold-700 dark:text-gold-400 border border-gold-500/30 rounded-md transition hover:scale-105 flex items-center justify-center cursor-pointer"
