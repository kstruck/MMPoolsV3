...
export const SuperAdminBentoDashboard: React.FC<SuperAdminBentoDashboardProps> = ({ stats }) => {
  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 items-stretch p-4 md:p-8 bg-page min-h-screen text-[color:var(--text)] font-body selection:bg-brandred-600 selection:text-white">
      ...
      <div
        className="bg-card border border-line rounded-3xl p-6 shadow-card relative overflow-hidden transition-ui duration-150 hover:shadow-card-hover flex flex-col justify-between"
      >
        <div>
        ...
        <div>
          <div className="flex justify-between items-center mb-6">
            ...
            <button
              ...
              disabled={isProbing}
              className="flex items-center gap-2 px-3 py-2 bg-surface hover:bg-card border border-line rounded-xl transition-ui duration-150 text-muted hover:text-[color:var(--text)] active:scale-95 disabled:opacity-50 text-[10px] font-display font-bold uppercase tracking-[0.08em]"
            >
            ...
            <div className="space-y-3.5">
              {checkEntries.map(([key, c]) => {
                ...
                return (
                  <div
                    key={key}
                    className="flex justify-between items-center p-3.5 bg-surface border border-line rounded-2xl transition-ui duration-150 hover:border-gold-500/40"
                  >
                    <div className="flex items-center gap-3">
