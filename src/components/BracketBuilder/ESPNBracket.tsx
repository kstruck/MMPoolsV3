...
const TeamRow: React.FC<TeamRowProps> = ({
    ...
    return (
        <button
            ...
            disabled={disabled}
            className={`
                w-full flex items-center h-[34px] px-1.5 gap-1.5 text-left transition-ui relative
                ${bg}
...
const MatchupCard: React.FC<MatchupCardProps> = ({
    ...
    return (
        <div
            className={`flex flex-col border rounded-sm bg-card overflow-hidden flex-shrink-0 transition-ui relative ${cardBorder}`}
            style={style}
        >
                ...
                <div className="flex flex-col gap-3 ml-auto">
                    ...
                    <div className="flex gap-2">
                        <button onClick={copyLink}
                            className="flex items-center gap-1.5 px-4 py-2 border-[1.5px] border-line rounded-lg text-[12px] font-display font-bold uppercase tracking-[0.05em] text-[color:var(--text)] hover:border-navy-600 hover:bg-card transition-ui duration-150 fine:hover:-translate-y-px">
                            <Link className="w-3.5 h-3.5" /> Copy Link
                        </button>
                        <button onClick={printBracket}
                            className="flex items-center gap-1.5 px-4 py-2 bg-navy-800 rounded-lg text-[12px] font-display font-bold uppercase tracking-[0.05em] text-white hover:bg-navy-700 transition-ui duration-150 fine:hover:-translate-y-px">
