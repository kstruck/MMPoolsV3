            ...
            {!readOnly && view === 'tabs' && (
                <div className="p-4 border-t border-line flex justify-between bg-surface backdrop-blur">
                    ...
                    <button
                        ...
                        className="px-6 py-2 bg-brandred-600 hover:bg-brandred-500 text-white rounded-lg font-display font-bold uppercase tracking-[0.05em] flex items-center gap-2 shadow-red-cta disabled:opacity-50 disabled:cursor-not-allowed transition duration-150 hover:-translate-y-px"
                    >
