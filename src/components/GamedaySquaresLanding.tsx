...
export const GamedaySquaresLanding: React.FC<GamedaySquaresLandingProps> = ({ user, isManager = false, onLogin, onSignup, onLogout, onCreatePool, onBrowse, isLoggedIn }) => {
    ...
    return (
        <div className="min-h-screen bg-navy-950 text-white font-body">
            ...
            <section className="py-24 border-t border-[rgba(230,206,150,0.16)] relative overflow-hidden bg-navy-950">
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10 space-y-32">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20">
                        <div className="md:w-1/2 relative group">
                            ...
                            <img
                                ...
                                className="relative rounded-xl shadow-panel border border-[rgba(230,206,150,0.16)] w-full transform group-hover:scale-[1.02] transition-transform duration-500"
                            />
                        </div>
                        <div className="md:w-1/2 space-y-6">
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full font-display font-bold uppercase text-xs tracking-[0.16em] bg-gold-500/15 text-gold-400">
                                <LayoutGrid size={14} /> The Main Event
                            </div>
                            <h3 className="font-display font-extrabold uppercase text-3xl md:text-4xl text-white leading-[0.95]">
                                Live, Interactive Grids for <br /><span className="text-gold-400">Game Day Action.</span>
                            </h3>
                            <p className="text-lg leading-relaxed font-body text-[#EDF1F8]">
                    ...
                    <div className="flex flex-col md:flex-row-reverse items-center gap-12 md:gap-20">
                        ...
                        <div className="md:w-1/2 space-y-6">
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full font-display font-bold uppercase text-xs tracking-[0.16em] bg-navy-700/50 text-[#9FB0CC] border border-[rgba(230,206,150,0.16)]">
                                <Zap size={14} /> Mission Control
                            </div>
                            <h3 className="font-display font-extrabold uppercase text-3xl md:text-4xl text-white leading-[0.95]">
                                Everything You Need.<br /><span className="text-gold-400">All in One View.</span>
                            </h3>
                            <p className="text-lg leading-relaxed font-body text-[#EDF1F8]">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20">
                        ...
                        <div className="md:w-1/2 space-y-6">
                            ...
                            <h3 className="font-display font-extrabold uppercase text-3xl md:text-4xl text-white leading-[0.95]">
                                Know Who Wins.<br /><span className="text-gold-400">Before the Whistle Blows.</span>
                            </h3>
                            <p className="text-lg leading-relaxed font-body text-[#EDF1F8]">
                    ...
                    <div className="flex flex-col md:flex-row-reverse items-center gap-12 md:gap-20">
                        ...
                        <div className="md:w-1/2 space-y-6">
                            ...
                            <h3 className="font-display font-extrabold uppercase text-3xl md:text-4xl text-white leading-[0.95]">
                                Launch in Minutes.<br /><span className="text-gold-400">Your Rules, Your Way.</span>
                            </h3>
                            <p className="text-lg leading-relaxed font-body text-[#EDF1F8]">
            ...
            <section id="features" className="py-24 border-y border-[rgba(230,206,150,0.16)] bg-navy-900/60">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-16">
                        <h2 className="font-display font-extrabold uppercase text-3xl md:text-4xl leading-[0.95] text-white mb-4">Why Choose Our Platform?</h2>
                        <p className="font-body text-[#9FB0CC]">Ditch the poster board and spreadsheets. Upgrade to a fully automated system.</p>
                    </div>
            ...
            {/* CTA Section */}
            <div className="pt-24 pb-12 bg-navy-950">
