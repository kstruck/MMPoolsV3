         ...
         <div className="bg-slate-800 border border-slate-600 p-6 rounded-xl shadow-2xl max-w-sm w-full">
            <div className="flex justify-between items-start mb-4">
               <h3 className="text-xl font-bold text-white flex items-center gap-2">
                  <UserIcon className="text-indigo-400" /> Player Details
               </h3>
               <button onClick={() => setShowGuestModal(false)} className="text-slate-500 hover:text-white transition-colors">
                  <X size={20} />
               </button>
            </div>
            ...
            <div className="space-y-4 mb-6">
               <div>
                  ...
                  <input
                     ...
                     className="w-full bg-slate-950 border border-slate-700 rounded-lg px-4 py-3 text-white focus:ring-2 focus:ring-indigo-500 outline-none placeholder:text-slate-700"
               ...
               {errorMsg && (
                  <div className="text-xs text-rose-400 bg-rose-900/20 p-2 rounded border border-rose-500/20 flex items-center gap-2">
            ...
            <div className="flex gap-3">
               ...
               <button
                  ...
                  className="flex-1 py-3 bg-indigo-600 hover:bg-indigo-500 text-white rounded-lg font-bold shadow-lg shadow-indigo-500/20 flex items-center justify-center gap-2 transition-all"
               >
