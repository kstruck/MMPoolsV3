                ...
                <div className="lg:col-span-3 bg-card border border-line rounded-3xl p-6 shadow-panel flex flex-col justify-between">
                        ...
                        {editingTiers?.map((tier, index) => (
                            <div key={tier.id} className="bg-surface border border-line rounded-2xl p-4 flex flex-col md:flex-row items-center gap-4 relative group">
                                ...
                                <button
                                    ...
                                    className="p-2 border border-brandred-600/30 text-brandred-500 hover:bg-brandred-600/10 rounded-xl mt-3 md:mt-0 transition-ui duration-200"
                                    title="Delete Tier"
                                >
                                    <Trash2 size={16} />
                                </button>
                    ...
                    <div className="flex gap-3 mt-6 pt-4 border-t border-line">
                        <button
                            ...
                            className="flex items-center gap-1 bg-surface hover:bg-card text-[color:var(--text)] px-4 py-2 rounded-xl text-xs font-display font-bold uppercase tracking-[0.05em] transition-ui border border-line"
                        >
                            <Plus size={14} /> Add New Tier
                        </button>
                        <button
                            onClick={handleSaveTiers}
                            className="bg-brandred-600 hover:bg-brandred-500 text-white px-5 py-2 rounded-xl text-xs font-display font-bold uppercase tracking-[0.05em] transition-ui ml-auto shadow-red-cta"
                        >
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6 pb-4 border-b border-line">
                    ...
                    <div className="flex flex-wrap gap-2 shrink-0">
                        <button
                            ...
                            className="text-xs bg-surface hover:bg-card text-[color:var(--text)] font-display font-bold uppercase tracking-[0.05em] px-4 py-2.5 rounded-xl border border-line transition-ui flex items-center gap-1.5"
                        >
                        ...
                        <button
                            ...
                            className="text-xs bg-gold-500/10 hover:bg-gold-500/20 text-gold-700 dark:text-gold-400 font-display font-bold uppercase tracking-[0.05em] px-4 py-2.5 rounded-xl border border-gold-500/30 transition-ui flex items-center gap-1.5"
                        >
                        ...
                        <button
                            ...
                            className="text-xs bg-gold-foil text-navy-900 hover:brightness-105 font-display font-bold uppercase tracking-[0.05em] px-4 py-2.5 rounded-xl transition-ui shadow-card flex items-center gap-1.5"
                        >
                                    ...
                                    return (
                                        <tr key={u.id} className="hover:bg-surface transition-colors">
                                            ...
                                            <td className="p-4 flex gap-2">
                                                <a
                                                    href={`mailto:${u.email}`}
                                                    className="text-xs bg-surface hover:bg-card text-[color:var(--text)] px-2.5 py-1 rounded-lg border border-line transition-ui font-display font-bold uppercase tracking-[0.05em]"
                                                >
                                                    Email
                                                </a>
                                                <button
                                                    ...
                                                    className="text-xs bg-surface hover:bg-card text-[color:var(--text)] px-2.5 py-1 rounded-lg border border-line transition-ui"
                                                    title="Copy Email"
                                                >
                                                    <Copy size={12} />
                                                </button>
                                                <button
                                                    ...
                                                    className="text-xs bg-navy-600/10 hover:bg-navy-600/20 text-navy-700 dark:text-gold-400 border border-navy-600/30 px-2.5 py-1 rounded-lg transition-ui font-display font-black uppercase tracking-[0.05em]"
                                                >
                                                    Direct Mock Promo
                                                </button>
                                            </td>
                ...
                <OverlayRoot id="sa-promo-campaign" label="Mock promo campaign creator" onEscape={() => { setPromoUser(null); setPromoBulkTier(null); }} className="fixed inset-0 bg-black/80 z-[100] flex items-center justify-center p-4 backdrop-blur-sm animate-in fade-in duration-200">
                    <div className="bg-card border border-line rounded-3xl p-6 w-full max-w-lg shadow-panel flex flex-col justify-between relative">
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    <button
                                        ...
                                        className={`py-2 text-xs font-display font-bold uppercase tracking-[0.05em] rounded-xl border transition-ui flex items-center justify-center gap-1.5 ${promoType === 'coupon' ? 'bg-gold-500/10 border-gold-500/40 text-gold-700 dark:text-gold-400' : 'bg-surface border-line text-muted'}`}
                                    >
                                        <Ticket size={13} /> Discount Coupon
                                    </button>
                                    <button
                                        onClick={() => setPromoType('reminder')}
                                        className={`py-2 text-xs font-display font-bold uppercase tracking-[0.05em] rounded-xl border transition-ui flex items-center justify-center gap-1.5 ${promoType === 'reminder' ? 'bg-navy-600/10 border-navy-600/40 text-navy-700 dark:text-gold-400' : 'bg-surface border-line text-muted'}`}
                                    >
                        ...
                        <div className="flex gap-3 mt-6 pt-4 border-t border-line">
                            <button
                                onClick={() => { setPromoUser(null); setPromoBulkTier(null); }}
                                className="bg-surface hover:bg-card text-[color:var(--text)] px-4 py-2 rounded-xl text-xs font-display font-bold uppercase tracking-[0.05em] transition-ui border border-line"
                            >
                                Cancel
                            </button>
                            <button
                                ...
                                className="bg-brandred-600 hover:bg-brandred-500 text-white px-5 py-2 rounded-xl text-xs font-display font-bold uppercase tracking-[0.05em] transition-ui ml-auto shadow-red-cta disabled:opacity-50"
                            >
                    ...
                    {pools.filter(p => {
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {pools.filter(p => {
                                ...
                                return (
                                    <div key={pool.id} className="bg-card border border-line rounded-xl p-5 hover:border-gold-500/50 fine:hover:-translate-y-1 hover:shadow-card-hover transition-ui duration-150 group">
