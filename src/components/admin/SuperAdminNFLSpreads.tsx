      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <div className="flex items-end">
          <button
            onClick={fetchGames}
            disabled={isLoading}
            className="w-full bg-navy-800 hover:bg-navy-700 disabled:opacity-50 text-white font-display font-bold uppercase tracking-[0.05em] py-2.5 rounded-md flex items-center justify-center gap-2 transition duration-150 hover:-translate-y-px"
          >
        ...
        <>
          ...
          <div className="flex justify-end pt-4 border-t border-line">
            <button
              onClick={handleSave}
              disabled={isSaving}
              className="bg-gold-foil hover:brightness-105 disabled:opacity-50 text-navy-900 font-display font-bold uppercase tracking-[0.05em] px-8 py-3 rounded-md flex items-center gap-2 shadow-[0_6px_16px_rgba(140,109,51,0.28)] hover:-translate-y-px transition duration-150"
            >
