...
export const ProductionWatchdogCard: React.FC = () => {
  ...
  return (
    <div className="bg-card border border-line rounded-3xl p-6 shadow-card relative overflow-hidden transition-ui duration-150 hover:shadow-card-hover xl:col-span-2">
