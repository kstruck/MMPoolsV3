        ...
        <div className="space-y-6 animate-in slide-in-from-right duration-200">
            <div className="bg-surface border border-line rounded-xl p-6">
                <div className="flex justify-between items-start mb-6">
                    ...
                    }} className={`px-5 py-2.5 rounded-md text-sm font-display font-bold uppercase tracking-[0.05em] transition-ui duration-150 flex items-center gap-2 ${showSchedule ? 'bg-card hover:bg-surface text-muted border border-line' : 'bg-brandred-600 hover:bg-brandred-500 text-white shadow-[0_6px_16px_rgba(196,52,46,0.28)] fine:hover:-translate-y-px'}`}>
                ...
                {showSchedule && (
                    <div className="mb-6 bg-card border border-line rounded-xl p-4 animate-in fade-in">
                        <div className="flex flex-wrap items-center gap-2 mb-4">
                            ...
                            <button onClick={fetchSchedule} disabled={isLoadingSchedule} className="bg-brandred-600 hover:bg-brandred-500 text-white px-3 py-1 rounded-md font-display font-bold uppercase tracking-[0.05em] text-sm ml-auto flex items-center gap-2 transition-ui duration-150 fine:hover:-translate-y-px disabled:opacity-50">
                        ...
                        <div className="max-h-60 overflow-y-auto space-y-1 pr-1 custom-scrollbar">
                            ...
                            {scheduleGames.map((game: ESPNGame) => {
                                ...
                                return (
                                    <div key={game.id} onClick={() => selectGame(game)} className="flex items-center justify-between p-2 rounded hover:bg-surface cursor-pointer border border-transparent hover:border-navy-600/30 group transition-ui">
