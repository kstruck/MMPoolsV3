            ...
            <div className="bg-surface border border-line rounded-xl p-6">
                ...
                <div className="grid md:grid-cols-2 gap-4 mb-8">
                    ...
                    <button
                        ...
                        className={`relative p-6 rounded-2xl border-2 text-left transition-ui group ${!gameState.ruleVariations.scoreChangePayout
                    ...
                    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2">
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                            <button
                                ...
                                className={`relative p-5 rounded-xl border text-left transition-ui ${gameState.ruleVariations.scoreChangePayoutStrategy === 'equal_split'
                            ...
                            <button
                                ...
                                className={`relative p-5 rounded-xl border text-left transition-ui ${gameState.ruleVariations.scoreChangePayoutStrategy === 'hybrid'
                                    ? 'bg-navy-600/20 border-navy-600 ring-2 ring-navy-600'
                                    : 'bg-card border-line hover:border-navy-600'
                                    }`}
                            >
                        ...
                        <div className="animate-in fade-in slide-in-from-top-2 p-4 bg-card/50 border border-line rounded-lg">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                <button
                                    ...
                                    className={`p-3 rounded-lg border text-left transition-ui ${gameState.ruleVariations.unclaimedFinalPrizeStrategy === 'last_winner' || !gameState.ruleVariations.unclaimedFinalPrizeStrategy ? 'bg-navy-600/20 border-navy-600 text-navy-600 dark:text-navy-500' : 'bg-page border-line text-muted hover:border-navy-600'}`}
                                >
                                ...
                                <button
                                    ...
                                    className={`p-3 rounded-lg border text-left transition-ui ${gameState.ruleVariations.unclaimedFinalPrizeStrategy === 'random' ? 'bg-navy-600/20 border-navy-600 text-navy-600 dark:text-navy-500' : 'bg-page border-line text-muted hover:border-navy-600'}`}
                                >
                    ...
                    <div className="bg-surface border border-gold-500/50 rounded-2xl p-6 max-w-md mx-4 shadow-panel animate-in zoom-in-95">
                        ...
                        <div className="flex gap-3 justify-end">
                            ...
                            <button
                                ...
                                className="px-4 py-2 bg-gold-foil hover:brightness-105 text-navy-900 font-display font-bold uppercase tracking-[0.05em] rounded-md shadow-[0_6px_16px_rgba(140,109,51,0.28)] transition-ui duration-150 fine:hover:-translate-y-px"
                            >
                                Yes, Use Random Draw
                            </button>
                        </div>
