                        ...
                        <div className="space-y-3">
                            {questions.length === 0 ? (
                                ...
                                filteredQuestions.map((q) => {
                                    ...
                                    return (
                                        <div key={q.id} className="group bg-card border border-line hover:border-navy-600 rounded-lg p-4 transition-ui duration-150 flex items-start gap-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {filtered.map(seed => {
                            ...
                            return (
                                <div
                                    key={seed.id}
                                    className={`p-4 rounded-xl border transition-ui duration-150 ${added
