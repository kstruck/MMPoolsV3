                    ...
                    <div className="space-y-2">
                        {activeCards.map((card, idx) => {
                            ...
                            return (
                                <div
                                    key={card.id || idx}
                                    className={`p-3 rounded-lg flex items-center justify-between cursor-pointer transition duration-150 ${isViewing ? 'bg-navy-800/10 border border-navy-700 dark:border-gold-500' : 'bg-surface border border-line hover:border-navy-600'}`}
                                ...
                                {q.options.map((opt, optIdx) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`p-4 rounded-lg border text-left transition duration-150 relative ${borderClass} ${bgClass} ${viewingCardId ? 'cursor-default' : ''}`}
                                        >
