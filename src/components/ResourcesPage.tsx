...
export const ResourcesPage: React.FC<ResourcesPageProps> = ({ user, onLogin, onSignup, onCreatePool, onLogout }) => {
    return (
        <div className="min-h-screen bg-navy-950 text-white font-body">
            ...
            <div className="pt-24 pb-12 bg-navy-900/60 border-b border-[rgba(230,206,150,0.16)]">
            ...
            <div className="max-w-4xl mx-auto px-6 py-20 space-y-20">
                ...
                <article className="prose prose-invert max-w-none">
                    <div className="flex items-center gap-4 mb-6">
                        <div className="p-3 rounded-xl bg-gold-500/15 text-gold-400">
                            <Trophy size={32} />
                        </div>
                        <h2 className="font-display font-bold uppercase text-3xl leading-[0.95] text-white m-0">How to Set Up an NFL Playoff Pool</h2>
                    </div>
                    <p className="text-lg font-body text-[#EDF1F8] leading-relaxed">
                    ...
                    <h3 className="font-display font-bold uppercase text-xl text-white mt-8 mb-4">Step-by-Step Setup Guide</h3>
                    <ul className="space-y-4 list-none pl-0 font-body text-[#EDF1F8]">
                ...
                <hr className="border-[rgba(230,206,150,0.16)]" />

                {/* ARTICLE 2: SUPER BOWL SQUARES */}
                <article className="prose prose-invert max-w-none">
                    <div className="flex items-center gap-4 mb-6">
                        <div className="p-3 rounded-xl bg-navy-700/50 text-[#9FB0CC]">
                            <LayoutGrid size={32} />
                        </div>
                        <h2 className="font-display font-bold uppercase text-3xl leading-[0.95] text-white m-0">The Official Rules for Super Bowl Squares</h2>
                    </div>
                    <p className="text-lg font-body text-[#EDF1F8] leading-relaxed">
                    ...
                    <h3 className="font-display font-bold uppercase text-xl text-white mt-8 mb-4">How to Play</h3>
                    <div className="grid md:grid-cols-2 gap-8 my-8">
                        <div className="bg-navy-900 p-6 rounded-xl border border-[rgba(230,206,150,0.16)]">
                            <h4 className="font-display font-bold uppercase text-white mb-2">1. The Empty Grid</h4>
                            <p className="text-sm font-body text-[#9FB0CC]">Start with a 10x10 blank grid. Invite your friends or coworkers to purchase squares. They can pick specific spots or get assigned randomly.</p>
                        </div>
                        <div className="bg-navy-900 p-6 rounded-xl border border-[rgba(230,206,150,0.16)]">
                            <h4 className="font-display font-bold uppercase text-white mb-2">2. The Numbers</h4>
                            <p className="text-sm font-body text-[#9FB0CC]">Once the grid is full (or locked), assign numbers 0-9 randomly to the top row (Away Team) and left column (Home Team).</p>
                        </div>
                    </div>

                    <h3 className="font-display font-bold uppercase text-xl text-white mt-8 mb-4">Determining Winners</h3>
                    <p className="font-body text-[#EDF1F8] mb-4">
                        Winners are determined at the end of every quarter based on the <strong>last digit</strong> of each team's score.
                    </p>
                    <div className="bg-navy-900/60 p-4 border-l-4 border-gold-500 rounded-r-lg italic font-body text-[#EDF1F8]">
                ...
                <div className="pt-12 text-center">
                    <h3 className="font-display font-bold uppercase text-2xl text-white mb-6">Ready to host your own pool?</h3>
                    <button
                        onClick={onSignup}
                        className="bg-brandred-600 hover:bg-brandred-500 text-white px-8 py-4 rounded-lg font-display font-bold uppercase tracking-[0.05em] text-lg transition-all duration-150 hover:-translate-y-px shadow-red-cta"
                    >
                        Start a Free Pool
                    </button>
                </div>
