            ...
            <main className="flex-grow max-w-7xl mx-auto w-full p-4 md:p-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                    <div className="bg-card border border-line rounded-2xl p-4 shadow-card flex items-center gap-4 relative overflow-hidden group hover:border-gold-500/40 transition duration-150">
                        <div className="w-10 h-10 rounded-xl bg-navy-600/10 dark:bg-navy-600/30 border border-navy-600/20 text-navy-700 dark:text-[#9FB0CC] flex items-center justify-center group-hover:scale-105 transition">
                            <LayoutGrid size={20} />
                        </div>
                        <div>
                    ...
                    <div className="bg-card border border-line rounded-2xl p-4 shadow-card flex items-center gap-4 relative overflow-hidden group hover:border-gold-500/40 transition duration-150">
                        <div className="w-10 h-10 rounded-xl bg-gold-500/10 border border-gold-500/30 text-gold-700 dark:text-gold-400 flex items-center justify-center group-hover:scale-105 transition">
                            <TrendingUp size={20} />
                        </div>
                        <div>
                    ...
                    <div className="bg-card border border-gold-500/40 rounded-2xl p-4 flex items-center gap-4 relative overflow-hidden group hover:border-gold-500/60 transition duration-150"
                         style={{ boxShadow: `0 4px 15px ${BRAND.emeraldGlow}` }}>
                        <div className="w-10 h-10 rounded-xl bg-gold-foil text-navy-950 flex items-center justify-center group-hover:scale-105 transition">
                            <DollarSign size={20} />
                        </div>
                        <div>
                ...
                <div className="flex items-center gap-2 mb-6 border-b border-line overflow-x-auto">
                    {tabStrip.map(tab => (
                        <button
                            ...
                            className={`px-4 py-3.5 text-xs font-display font-bold uppercase tracking-[0.08em] border-b-2 transition whitespace-nowrap flex items-center gap-2 ${activeTab === tab.id
                        ...
                        {filteredPools.map(pool => {
                            ...
                            return (
                                <div
                                    ...
                                    className="group bg-card border border-line hover:border-gold-500 rounded-3xl p-5 transition duration-150 hover:-translate-y-1 shadow-card hover:shadow-card-hover cursor-pointer relative overflow-hidden flex flex-col justify-between"
                                >
                                    <div>
                                        ...
                                        <div className="space-y-2 mb-4">
                                            ...
                                            {isSquares && (
                                                <div className="h-1.5 w-full bg-line rounded-full overflow-hidden">
                                                    <div
                                                        className="h-full w-full origin-left bg-gold-foil transition-transform duration-300"
                                                        style={{ transform: `scaleX(${percentFull / 100})` }}
                                                    />
                                                </div>
                                            )}
                                        </div>
