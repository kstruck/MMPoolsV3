  ...
  <div className="pt-2 border-t border-line flex justify-end">
    <button
      ...
      className={`${justSaved
        ...
        : 'bg-[#0B5C37] hover:bg-[#0F7B4A]'} disabled:opacity-50 text-white font-display font-bold uppercase tracking-[0.05em] py-3 px-8 rounded-lg flex items-center gap-2 shadow-card transition duration-150 hover:-translate-y-px cursor-pointer text-sm`}
    >
      ...
      <nav className="bg-card border border-line shadow-card rounded-xl p-2 flex flex-wrap gap-1.5" aria-label="Commissioner sections">
        {COMMISH_TABS.map(t => (
          <button
            ...
            className={`min-h-[44px] px-4 rounded-lg font-display font-bold uppercase text-[11px] tracking-[0.08em] transition duration-150 cursor-pointer ${
              commishTab === t.id
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full font-body bg-page border border-line rounded-md px-4 py-2.5 text-[color:var(--text)] text-sm focus:outline-none focus:ring-2 focus:ring-navy-600 dark:focus:ring-gold-500 transition"
                />
              </div>
              <div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full font-body bg-page border border-line rounded-md px-4 py-2.5 text-[color:var(--text)] text-sm focus:outline-none focus:ring-2 focus:ring-navy-600 dark:focus:ring-gold-500 transition resize-none"
              />
            </div>
            ...
            <div className="space-y-4 pt-4 border-t border-line">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full font-body bg-page border border-line rounded-md px-4 py-2.5 text-[color:var(--text)] text-sm focus:outline-none focus:ring-2 focus:ring-navy-600 dark:focus:ring-gold-500 transition animate-none"
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full font-body bg-page border border-line rounded-md px-4 py-2.5 text-[color:var(--text)] text-sm focus:outline-none focus:ring-2 focus:ring-navy-600 dark:focus:ring-gold-500 transition cursor-pointer"
                >
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className={`w-full font-body bg-page border border-line rounded-md px-4 py-2.5 text-[color:var(--text)] text-sm focus:outline-none focus:ring-2 focus:ring-navy-600 dark:focus:ring-gold-500 transition ${confidenceMode ? 'opacity-40 cursor-not-allowed' : ''}`}
                  >
                ...
                <div className="grid grid-cols-2 gap-4 bg-page p-4 border border-line rounded-lg">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full font-body bg-page border border-line rounded-md px-3 py-2 text-[color:var(--text)] text-sm focus:outline-none focus:ring-2 focus:ring-navy-600 dark:focus:ring-gold-500 transition"
                    />
                  </div>
                  <div>
          ...
          <div className="bg-card border border-line shadow-card rounded-xl p-6 space-y-5">
            ...
            <div className="pt-2">
              <button
                ...
                className="w-full bg-brandred-600 hover:bg-brandred-500 disabled:opacity-50 text-white font-display font-bold uppercase tracking-[0.05em] py-3.5 px-4 rounded-lg flex items-center justify-center gap-2 shadow-red-cta transition duration-150 hover:-translate-y-px cursor-pointer"
              >
            ...
            <div className="p-5 border-b border-line bg-surface space-y-3">
              ...
              <div className="flex flex-wrap gap-2">
                <button
                  ...
                  className="min-h-[44px] inline-flex items-center gap-1.5 px-4 rounded-md font-display font-bold uppercase text-[10px] tracking-[0.08em] bg-gold-400/10 border border-gold-500/40 text-gold-600 dark:text-gold-400 hover:bg-gold-400/20 disabled:opacity-40 disabled:cursor-not-allowed transition duration-150 hover:-translate-y-px cursor-pointer"
                >
                  <BellRing size={12} />
                    ...
                    <tr key={row.uid} className="hover:bg-page transition-colors">
                      ...
                      <td className="py-3.5 px-5 text-right">
                        <button
                          ...
                          className="min-h-[44px] inline-flex items-center gap-1.5 px-3 rounded-md font-display font-bold uppercase text-[10px] tracking-[0.08em] bg-navy-800 text-white hover:bg-navy-700 disabled:opacity-40 disabled:cursor-not-allowed transition duration-150 hover:-translate-y-px cursor-pointer"
                        >
                          <BellRing size={10} />
            ...
            <div className="bg-page border border-line rounded-lg p-5 space-y-4">
              ...
              <div className="flex items-center justify-between gap-4 flex-wrap">
                ...
                <button
                  ...
                  className="min-h-[44px] bg-navy-800 hover:bg-navy-700 disabled:opacity-50 text-white font-display font-bold uppercase tracking-[0.05em] px-6 rounded-lg flex items-center gap-2 transition duration-150 hover:-translate-y-px cursor-pointer text-xs"
                >
                  <Clock size={13} />
            ...
            <div className="bg-brandred-600/5 border border-brandred-600/25 rounded-lg p-5 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full font-body bg-page border border-line rounded-md px-4 py-2.5 text-[color:var(--text)] text-sm focus:outline-none focus:ring-2 focus:ring-brandred-500 transition"
                />
              </div>
              <div className="flex justify-end">
                <button
                  ...
                  className="min-h-[44px] bg-brandred-600 hover:bg-brandred-500 disabled:opacity-50 text-white font-display font-bold uppercase tracking-[0.05em] px-6 rounded-lg flex items-center gap-2 shadow-red-cta transition duration-150 hover:-translate-y-px cursor-pointer text-xs"
                >
                  <Ban size={13} />
