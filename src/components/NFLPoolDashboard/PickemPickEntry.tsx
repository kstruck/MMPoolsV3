        ...
        <div className="flex items-center gap-3">
          ...
          {pickedCount < games.length && (
            <button
              ...
              className="shrink-0 inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-line bg-card text-[color:var(--text)] font-display font-bold uppercase text-[11px] tracking-[0.08em] hover:border-gold-500/60 hover:shadow-card transition duration-150"
            >
