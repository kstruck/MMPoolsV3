            ...
            <div className="bg-card border border-line rounded-xl p-6 shadow-card">
                ...
                <div className="flex justify-between items-start mb-6">
                    ...
                    <button
                        ...
                        className={`px-4 py-2 rounded-lg text-sm font-display font-bold uppercase tracking-[0.05em] transition-ui duration-150 flex items-center gap-2 ${showSchedule ? 'bg-surface text-muted border border-line' : 'bg-brandred-600 text-white shadow-red-cta hover:bg-brandred-500 fine:hover:-translate-y-px'}`}
                    >
                        <Calendar size={16} />
                    ...
                    <div className="mb-8 bg-surface border border-line rounded-xl p-4 animate-in fade-in">
                        ...
                        <div className="max-h-60 overflow-y-auto space-y-1 custom-scrollbar pr-1">
                            ...
                            {scheduleGames.map((game) => {
                                ...
                                return (
                                    <div key={game.id} onClick={() => selectGame(game)} className="flex items-center justify-between p-2 rounded hover:bg-card cursor-pointer border border-transparent hover:border-navy-600/30 group transition-ui">
                ...
                <div className="space-y-4">
                    ...
                    {(homeLogo || awayLogo) && (
                        <div className="flex justify-center items-center gap-8 py-4 opacity-50 grayscale hover:grayscale-0 transition-ui duration-500">
