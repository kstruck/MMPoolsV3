    ...
    return (
        <div className="relative">
            <button
                ...
                className="bg-navy-800 hover:bg-navy-700 text-white px-4 py-2 rounded-lg font-display font-bold uppercase tracking-[0.05em] flex items-center gap-2 text-sm transition duration-150 hover:-translate-y-px"
            >
