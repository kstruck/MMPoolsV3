                            ...
                            return (
                                <div key={game.id} className="flex items-center gap-2">
                                    <button
                                        ...
                                        className={`flex-1 px-3 py-2.5 rounded-lg text-sm font-bold border transition-ui duration-150 ${homeSelected
                                    ...
                                    <button
                                        ...
                                        className={`flex-1 px-3 py-2.5 rounded-lg text-sm font-bold border transition-ui duration-150 ${awaySelected
                                            ? 'bg-gold-400 border-gold-500 text-navy-900'
                                            : 'bg-surface border-line text-[color:var(--text)] hover:border-gold-500'
                                            }`}
                                    >
