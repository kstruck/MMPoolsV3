...
import { Trash2, Shield, Activity, Heart, Users, Settings, ToggleLeft, ToggleRight, PlayCircle, Search, Palette, Plus, Eye, EyeOff, Star, Copy, X, List, Bot, Trophy, Lock, CheckCircle, XCircle, RefreshCw, Globe, PartyPopper, Sparkles } from 'lucide-react';
...
import { MembersUsersPanel, MembersReferralsComputedPanel, MembersLoyaltyPanel, MembersReferralsStoredPanel, MembersEditUserModal, MembersViewUserModal } from './admin/MembersTab';
        ...
        <div className="w-[80%] mx-auto py-4 md:py-6 relative font-body text-[color:var(--text)]">
                ...
                <div className="flex flex-wrap gap-2 p-1 bg-surface rounded-xl border border-line backdrop-blur-sm w-fit">
                    {(Object.keys(navStructure) as NavGroup[]).map(group => (
                        <button
                            ...
                            className={`px-4 py-2 rounded-lg text-sm font-display font-bold uppercase tracking-[0.05em] transition-ui ${activeGroup === group
            ...
            {activeTab === 'referrals' && (
                <MembersReferralsComputedPanel
                    users={users}
                    getComputedReferrals={getComputedReferrals}
                    handleViewUser={handleViewUser}
                />
            )}
            ...
            {activeTab === 'loyalty' && (
                <MembersLoyaltyPanel
                    users={users}
                    userPoolCounts={userPoolCounts}
                    userTiers={userTiers}
                    activeTiers={activeTiers}
                    editingTiers={editingTiers}
                    setEditingTiers={setEditingTiers}
                    handleSaveTiers={handleSaveTiers}
                    handleAddTierLocal={handleAddTierLocal}
                    handleRemoveTierLocal={handleRemoveTierLocal}
                    selectedMarketingTier={selectedMarketingTier}
                    setSelectedMarketingTier={setSelectedMarketingTier}
                    marketingSearch={marketingSearch}
                    setMarketingSearch={setMarketingSearch}
                    promoUser={promoUser}
                    setPromoUser={setPromoUser}
                    promoBulkTier={promoBulkTier}
                    setPromoBulkTier={setPromoBulkTier}
                    promoSubject={promoSubject}
                    setPromoSubject={setPromoSubject}
                    promoMessage={promoMessage}
                    setPromoMessage={setPromoMessage}
                    promoCoupon={promoCoupon}
                    setPromoCoupon={setPromoCoupon}
                    promoType={promoType}
                    setPromoType={setPromoType}
                    isSendingPromo={isSendingPromo}
                    setIsSendingPromo={setIsSendingPromo}
                    handleViewUser={handleViewUser}
                    toast={toast}
                />
            )}
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {themes.map((theme) => (
                            <div
                                key={theme.id}
                                className={`bg-card rounded-xl border overflow-hidden transition-ui shadow-card ${theme.isDefault ? 'border-gold-500' : theme.isActive ? 'border-[#0F7B4A]/50' : 'border-line'}`}
                            >
                                {/* Preview */}
                                <div
                ...
                <div className="space-y-6 w-full">
                    ...
                    <div className="bg-card border border-line rounded-2xl p-5 flex items-center justify-between gap-4 shadow-card">
                        ...
                        <button
                            ...
                            className="shrink-0 bg-navy-800 hover:bg-navy-700 text-white font-display font-bold uppercase tracking-[0.05em] px-5 py-3 rounded-xl text-sm transition-ui duration-150 fine:hover:-translate-y-px shadow-card whitespace-nowrap flex items-center gap-2"
                        >
                    ...
                    <div className="bg-card border border-line rounded-2xl p-5 flex items-center justify-between gap-4 shadow-card">
                        ...
                        <button
                            ...
                            className="shrink-0 bg-brandred-600 hover:bg-brandred-500 text-white font-display font-bold uppercase tracking-[0.05em] px-5 py-3 rounded-xl text-sm transition-ui duration-150 fine:hover:-translate-y-px shadow-red-cta whitespace-nowrap flex items-center gap-2"
                        >
                                ...
                                <div className="flex items-center gap-2">
                                    {(viewingPool.type === 'NFL_PLAYOFFS' || viewingPool.type === 'BRACKET') && (
                                        <button
                                            ...
                                            className="px-3 py-1.5 bg-gold-500/10 text-gold-700 dark:text-gold-400 hover:bg-gold-500/20 border border-gold-500/50 rounded-lg text-xs font-display font-bold uppercase tracking-[0.05em] transition-ui"
                                        >
                                            Fix Max Entries
                                        </button>
                                    )}
                            ...
                            <div className="flex border-b border-line bg-surface px-6 py-2 overflow-x-auto gap-2">
                                {[
                                    ...
                                    <button
                                        ...
                                        className={`px-4 py-2 text-xs font-display font-bold uppercase tracking-[0.08em] rounded-lg transition-ui ${
                                            modalTab === tab.id
                                                ? 'bg-navy-800 text-white shadow-card'
                                                : 'text-muted hover:text-[color:var(--text)] hover:bg-card'
                                        }`}
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <button
                                                        ...
                                                        className={`w-full flex items-center justify-between p-3 rounded-xl border transition-ui ${
                                                            adminIsPublic
                                            ...
                                            <div className="pt-2">
                                                <button
                                                    ...
                                                    className="w-full bg-brandred-600 hover:bg-brandred-500 text-white font-display font-bold uppercase tracking-[0.05em] py-3 rounded-xl transition-ui shadow-red-cta flex items-center justify-center gap-2"
                                                >
                                                    <CheckCircle size={18} />
                                                                    ...
                                                                    <tr className="hover:bg-card transition-colors">
                                                                        ...
                                                                        <td className="p-4 text-center">
                                                                            <button
                                                                                ...
                                                                                className={`px-3 py-1.5 rounded-full text-xs font-display font-bold uppercase tracking-[0.08em] border transition-ui ${
                                        ...
                                        <div className="space-y-4">
                                            <div className="p-4 bg-surface rounded-xl border border-line flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                                                ...
                                                <button
                                                    ...
                                                    className="w-full sm:w-auto px-4 py-2.5 bg-navy-800 hover:bg-navy-700 text-white rounded-xl text-xs font-display font-bold uppercase tracking-[0.05em] transition-ui shadow-card flex items-center justify-center gap-1.5"
                                                >
                                                    <RefreshCw size={14} />
                                                    Process ESPN Sync
                                                </button>
                                            ...
                                            {viewingPool.type === 'BRACKET' && (
                                                <div className="p-4 bg-surface rounded-xl border border-line flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                                                    ...
                                                    <button
                                                        ...
                                                        className="w-full sm:w-auto px-4 py-2.5 bg-brandred-600 hover:bg-brandred-500 text-white rounded-xl text-xs font-display font-bold uppercase tracking-[0.05em] transition-ui shadow-red-cta"
                                                    >
                                                        Close Pool
                                                    </button>
                                                </div>
                                            ...
                                            <div className="p-4 bg-surface rounded-xl border border-line flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                                                ...
                                                <button
                                                    ...
                                                    className="w-full sm:w-auto px-4 py-2.5 bg-card hover:bg-page border border-line text-[color:var(--text)] rounded-xl text-xs font-display font-bold uppercase tracking-[0.05em] transition-ui shadow-card text-center"
                                                >
                                                    Configure settings
                                                </button>
                                            </div>
                                            ...
                                            <div className="p-4 bg-brandred-600/5 rounded-xl border border-brandred-600/40 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                                                ...
                                                <button
                                                    ...
                                                    className="w-full sm:w-auto px-4 py-2.5 bg-brandred-600 hover:bg-brandred-700 text-white rounded-xl text-xs font-display font-bold uppercase tracking-[0.05em] transition-ui shadow-red-cta"
                                                >
                                                    Super Delete Pool
                                                </button>
                                            </div>
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {availableCategories.map(cat => (
                                            <button
                                                ...
                                                className={`px-3 py-1 rounded-full text-xs font-display font-bold uppercase tracking-[0.05em] transition-ui border ${seedCategories.includes(cat)
                        ...
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                            ...
                            <div className="flex gap-3">
                                <button
                                    ...
                                    className="bg-navy-800 hover:bg-navy-700 text-white px-6 py-2 rounded-xl font-display font-bold uppercase tracking-[0.05em] transition-ui shadow-card flex items-center gap-2"
                                >
                                ...
                                <button
                                    ...
                                    className="bg-brandred-600 hover:bg-brandred-500 disabled:opacity-50 text-white px-6 py-2 rounded-xl font-display font-bold uppercase tracking-[0.05em] transition-ui shadow-red-cta"
                                >
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-3">
                                    {playoffTeams.filter(t => t.conference === 'AFC').sort((a, b) => a.seed - b.seed).map((team) => {
                                        ...
                                        return (
                                            <div key={overallIdx} className={`p-4 rounded-xl border transition-ui ${team.eliminated ? 'bg-surface border-line opacity-50' : 'bg-surface border-line shadow-card'}`}>
                                                <div className="flex items-center gap-4">
