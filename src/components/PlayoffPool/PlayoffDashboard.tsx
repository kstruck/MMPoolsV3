                        ...
                        <div className="flex-shrink-0">
                            ...
                            <div className="flex items-center gap-3 text-muted text-sm">
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-2 text-xs font-display font-bold uppercase tracking-[0.05em] text-white bg-navy-800 hover:bg-navy-700 transition-ui duration-150 ml-2 px-3 py-1.5 rounded-lg fine:hover:-translate-y-px"
                                >
                                        ...
                                        {pool.zelle && (
                                            <div className="bg-surface border border-line text-[color:var(--text)] px-4 py-3 rounded-lg font-bold flex items-center gap-2 justify-between group">
                                                ...
                                                <button
                                                    ...
                                                    className="bg-card border border-line hover:bg-page p-2 rounded transition-ui duration-150 transform active:scale-95"
