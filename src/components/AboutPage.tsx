...
export const AboutPage: React.FC<AboutPageProps> = ({ user, isManager = false, onLogin, onLogout, onCreatePool }) => {
    return (
        <div className="min-h-screen text-[color:var(--text)] font-body bg-page flex flex-col">
            ...
            {/* Hero Header — navy chrome (always dark) */}
            <section className="relative overflow-hidden pt-20 pb-16 border-b border-[rgba(230,206,150,0.16)] bg-navy-950">
            ...
            {/* Bento Grid Features — flips */}
            <section className="py-16 max-w-7xl mx-auto px-6 w-full flex-grow space-y-16">

                {/* Section Title */}
                <div className="text-center space-y-2">
                    <h2 className="font-display font-extrabold uppercase text-2xl md:text-3xl leading-[0.95] text-[color:var(--text)]">The Platform Engine</h2>
                    <p className="text-sm font-body text-muted max-w-lg mx-auto">We build automated solutions designed to let commissioners sit back and enjoy the games.</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 p-8 rounded-3xl bg-card border border-line hover:border-gold-500/40 transition-colors flex flex-col justify-between space-y-6">
                        <div className="space-y-4">
                            <div className="p-3 bg-gold-500/15 text-gold-600 dark:text-gold-400 rounded-2xl w-fit border border-gold-500/25">
                                <Sparkles size={24} />
                            </div>
                            <h3 className="font-display font-bold uppercase text-2xl text-[color:var(--text)]">The Core Mission</h3>
                    ...
                    <div className="p-8 rounded-3xl bg-card border border-line hover:border-gold-500/40 transition-colors space-y-4 flex flex-col justify-between">
                        <div className="space-y-4">
                            <div className="p-3 bg-navy-600/15 text-navy-700 dark:text-[#9FB0CC] rounded-2xl w-fit border border-line">
                                <Zap size={24} />
                            </div>
                            <h3 className="font-display font-bold uppercase text-xl text-[color:var(--text)]">Firestore Real-Time Scoring</h3>
                        ...
                        <div className="font-display font-bold uppercase text-[10px] tracking-[0.08em] text-faint">Live Integrations</div>
                    </div>
                    ...
                    <div className="p-8 rounded-3xl bg-card border border-line hover:border-gold-500/40 transition-colors space-y-4 flex flex-col justify-between">
                        <div className="space-y-4">
                            ...
                            <h3 className="font-display font-bold uppercase text-xl text-[color:var(--text)]">What-If Standing Simulators</h3>
                            <p className="font-body text-muted text-xs leading-relaxed">
                        ...
                        <div className="font-display font-bold uppercase text-[10px] tracking-[0.08em] text-faint">Recursive Analytics</div>
                    </div>
                    ...
                    <div className="p-8 rounded-3xl bg-card border border-line hover:border-gold-500/40 transition-colors space-y-4 flex flex-col justify-between">
                        <div className="space-y-4">
                            ...
                            <h3 className="font-display font-bold uppercase text-xl text-[color:var(--text)]">Custom AI Commissioner</h3>
                            <p className="font-body text-muted text-xs leading-relaxed">
                        ...
                        <div className="font-display font-bold uppercase text-[10px] tracking-[0.08em] text-faint">LLM Integrations</div>
                    </div>
                    ...
                    <div className="p-8 rounded-3xl bg-card border border-line hover:border-gold-500/40 transition-colors space-y-4 flex flex-col justify-between">
                        <div className="space-y-4">
                            ...
                            <h3 className="font-display font-bold uppercase text-xl text-[color:var(--text)]">Tamper-Proof Audit Logs</h3>
                            <p className="font-body text-muted text-xs leading-relaxed">
                        ...
                        <div className="font-display font-bold uppercase text-[10px] tracking-[0.08em] text-faint">Secure Database</div>
                    </div>
                </div>

                {/* Section 3: Social & Charity Impact */}
                <div className="p-8 md:p-12 rounded-3xl bg-card border border-gold-500/25 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                    <div className="lg:col-span-8 space-y-4">
                        <div className="inline-flex items-center gap-2 rounded-full px-3 py-1 bg-gold-500/15 border border-gold-500/25 text-gold-600 dark:text-gold-400">
                            <Heart size={14} />
                            <span className="font-display font-bold uppercase text-xs tracking-[0.16em]">Social Impact</span>
                        </div>
                        <h3 className="font-display font-extrabold uppercase text-3xl text-[color:var(--text)] leading-[0.95]">
                    ...
                    <div className="lg:col-span-4 bg-surface border border-line p-6 rounded-2xl space-y-2 text-center">
                        <div className="font-display font-extrabold text-3xl text-gold-600 dark:text-gold-400 num">$1,000,000</div>
                        <div className="font-display font-bold uppercase text-xs tracking-[0.08em] text-muted">Pledge Target</div>
                    </div>
                </div>
