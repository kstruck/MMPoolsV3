...
> **STATUS: ✅ SIGNED 2026-08-15 (K1–K12, "all recommendations"). SHIPPED: T3 (#451), T4 (#455), T5 (#456; ledger UX #460), T6 (#465), T7 (#466), T0 (#469). T1 (#470). T2 (wizard + manager second editor, `PayoutsPanel` per-pot lists) in its PR. Absent `weeklyPayouts` ⇒ `payouts` prices both pots (`weeklyPlacesFor`).**
