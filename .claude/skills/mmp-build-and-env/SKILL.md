...
| `GEMINI_API_KEY` | `.agent/skills/front-end-skill` (image-generation agent skill) | NOT read by the app. **CORRECTED 2026-08-23: the leak claim is TRUE** — `git show 3340fff0^:.env` in the public repo shows `VITE_API_KEY` (a Gemini key), exposed since 2025-12-13; the 2026-07-06 owner denial was wrong. Rotation is Kevin's owed action (HANDOFF). |
